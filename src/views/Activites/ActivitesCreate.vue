...
const {storeActivite,errors}= useActivites();
const form =reactive({
    name: "",
    prefixe : "",
    client_id: ""
...
<template>
    ...
    <div class="mt-12">
        <form class="max-w-md mx-auto p-4 bg-white shadow-md rounded-md" @submit.prevent="storeActivite(form)">
            <div class="space-y-6">
                ...
                <div class="mb-6">
                    <label for="prefixe" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">prefixe</label>
                    <input type="text" 
                    id="prefixe"
